...
def plot_conversion_metrics(mql_filtered, cld_filtered, merged_filtered):
    with st.container():
        ...
        st.markdown('<div class="visual-title" style="color:#000000;">Conversion Metrics</div>', unsafe_allow_html=True)
...
def plot_business_metrics(cld_filtered):
    with st.container():
        st.markdown('<div class="custom-frame">', unsafe_allow_html=True)
        st.markdown('<div class="visual-title" style="color:#000000;">Business Metrics</div>', unsafe_allow_html=True)
...
def plot_time_metrics(merged_filtered):
    with st.container():
        st.markdown('<div class="custom-frame">', unsafe_allow_html=True)
        st.markdown('<div class="visual-title" style="color:#000000;">Time Metrics</div>', unsafe_allow_html=True)
...
def plot_team_performance(cld_filtered):
    with st.container():
        st.markdown('<div class="custom-frame">', unsafe_allow_html=True)
        st.markdown('<div class="visual-title" style="color:#000000;">Team Performance</div>', unsafe_allow_html=True)
...
def plot_order_analysis(order_filtered):
    with st.container():
        st.markdown('<div class="custom-frame">', unsafe_allow_html=True)
        st.markdown('<div class="visual-title" style="color:#000000;">Order Analysis</div>', unsafe_allow_html=True)
...
def main():
    ...
    with st.sidebar:
        st.markdown('<h2 style="color: #FF5733;">Data Upload</h2>', unsafe_allow_html=True)
    ...
    if uploaded_files:
        ...
        st.markdown('<h2 style="color:#000000;">Key Performance Indicators</h2>', unsafe_allow_html=True)
